    ...
    <div className="bg-card text-card-foreground border border-border rounded-2xl shadow-sm overflow-hidden flex flex-col">
      ...
      <div className="p-5 border-b border-border flex flex-col sm:flex-row items-center justify-between gap-4 bg-muted/20">
        ...
        <div className="relative w-full sm:max-w-md">
          ...
          <input
            type="text"
            placeholder="Search exams by title, subject or ID..."
            value={searchTerm}
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          ...
          <button className="flex h-10 items-center justify-center gap-2 rounded-xl border border-input bg-background px-5 py-2 text-sm font-semibold shadow-sm hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring transition-colors">
