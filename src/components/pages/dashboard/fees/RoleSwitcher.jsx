...
export default function RoleSwitcher({ currentRole, onRoleChange }) {
  return (
    <div className="bg-slate-100 dark:bg-slate-800/60 p-1.5 rounded-2xl border border-slate-200 dark:border-slate-700 inline-flex flex-wrap items-center gap-1 z-1">
      <div className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 text-primary font-semibold text-xs tracking-wider uppercase">
